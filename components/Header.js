    ...
    return (
          <header className="sticky top-0 bg-white">
            <div className="flex w-full p-6 items-center">
              ...
              <XIcon className="h-7 sm:mr-3 text-gray-500 cursor-pointer tarnsition duration-100 transform hover:scale-125 "
          ...
          <Avatar className="ml-auto" url="https://i.pinimg.com/564x/de/6b/29/de6b295da4ff46c17e31688c5b274f8a.jpg" /> 
